    ...
    return (
        ...
        >
            ...
            <style>{`
                ...
                .label-header { background: #1e293b !important; }
                .label-header img { filter: brightness(0.9); }
